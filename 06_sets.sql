...
SQL set operations enable you to combine results from multiple
queries into a single result set. This script demonstrates 
the rules and usage of operations, including UNION, UNION ALL, EXCEP, and INTERSECT.
