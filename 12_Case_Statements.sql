/* ====================================================
	SQL CASE STATEMENT
--------------------------------------------------------
	This script demonstrates various use cases of the SQL 
	CASE statement, including data categorization, mapping,
	quik form syntax, handling nulls, and conditional
	aggregation.
