...
--No Join
/* Retrieve all data from customers and orders as separate resutls */
...
--Right JOIN
/* Get all customers along with their orders,
	indlcuding orders without matching customers*/
...
/*Get all customers along with their orders,
	inluding orders without matching customers. */
...
--Alternative to RIGHT ANTI JOIN usig LEFT JOIN
/* Get all orders without matching customers */
